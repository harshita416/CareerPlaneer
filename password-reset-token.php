...
if(isset($_POST['password-reset-token']) && $_POST['email'])
{
  ...
  if($row)
  {
    ...
    $update = mysqli_query($con,"UPDATE user set  password='" . $password . "', reset_link_token='" . $token . "' ,exp_date='" . $expDate . "' WHERE email='" . $emailId . "'");

    $link = "<a href='www.yourwebsite.com/reset-password.php?key=".$emailId."&token=".$token."'>Click To Reset password</a>";

    require_once('phpmail/PHPMailer-master.php');
